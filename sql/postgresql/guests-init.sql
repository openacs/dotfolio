...
--
-- Initialise the dotFOLIO Guests package
--
...
begin
	...
	''dotfolio_guest_profile_rel'',
        ''dotFOLIO Profile Guest'',
        ''dotFOLIO Profile Guests'',
	''dotfolio_user_profile_rel'',
        ''dotfolio_guest_profile_rels'',
        ''rel_id'',
        ''dotfolio_guest_profile_rel'',
        ''profiled_group'',
        null,
    ...
    values
    (''guest'', ''#dotfolio.guest_role_pretty_name#'', ''dotfolio_guest_profile_rel'', gid, sid);
