...
--
-- Implementation of the profile provider interface for dotFOLIO Advisers.
--
...
begin
    ...
    -- add the bindings to the method implementations
        ...
        perform acs_sc_impl_alias__new(
            ...
            ''dotfolio_adviser_profile_provider'',
            ''name'',
            ''dotfolio_adviser_profile_provider::name'',
            ''TCL''
        );
        ...
        perform acs_sc_impl_alias__new(
            ...
            ''dotfolio_adviser_profile_provider'',
            ''prettyName'',
            ''dotfolio_adviser_profile_provider::prettyName'',
            ''TCL''
        );
        ...
        perform acs_sc_impl_alias__new(
            ...
            ''dotfolio_adviser_profile_provider'',
            ''render'',
            ''dotfolio_adviser_profile_provider::render'',
            ''TCL''
        );
