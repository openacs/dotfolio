...
--
-- Initialise the dotFOLIO Advisers package
--
...
begin
    ...
    PERFORM acs_rel_type__create_type(
        ''dotfolio_adviser_profile_rel'',
        ''dotFOLIO Adviser Profile Adviser'',
        ''dotFOLIO Adviser Profile Advisers'',
	''dotfolio_user_profile_rel'',
        ''dotfolio_adviser_profile_rels'',
        ''rel_id'',
        ''dotfolio_adviser_profile_rel'',
        ''profiled_group'',
        null,
    ...
    values
    (''adviser'', ''#dotfolio.adviser_role_pretty_name#'', ''dotfolio_adviser_profile_rel'', gid, sid);
