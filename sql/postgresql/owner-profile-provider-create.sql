...
--
-- Implementation of the profile provider interface for dotFOLIO Owners.
--
...
begin
    ...
    perform acs_sc_impl__new(
        ''profile_provider'',
        ''dotfolio_owner_profile_provider'',
        ''dotfolio_owner_profile_provider''
    );
    ...
    -- add the bindings to the method implementations
        ...
        perform acs_sc_impl_alias__new(
            ...
            ''dotfolio_owner_profile_provider'',
            ''name'',
            ''dotfolio_owner_profile_provider::name'',
            ''TCL''
        );
        ...
        perform acs_sc_impl_alias__new(
            ...
            ''dotfolio_owner_profile_provider'',
            ''prettyName'',
            ''dotfolio_owner_profile_provider::prettyName'',
            ''TCL''
        );
        ...
        perform acs_sc_impl_alias__new(
            ...
            ''dotfolio_owner_profile_provider'',
            ''render'',
            ''dotfolio_owner_profile_provider::render'',
            ''TCL''
        );
